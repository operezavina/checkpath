...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { patient_id: @assignment.patient_id, template_id: @assignment.template_id } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { patient_id: @assignment.patient_id, template_id: @assignment.template_id } }
